...
def verifica_caracter(texto):
    texto = texto.lower()
    novo_texto = ''
    letra = 0
    caracters = [' ', "'", '"', '!','?', '.', ':', ',',';']
    while letra < len(texto):
        if texto[letra] in caracters:
            novo_texto += ''
        else:
            novo_texto += texto[letra]
        letra += 1
    return novo_texto

def identifica_sortudo(numero):    
    num = str(numero)
    i = 0
    if '7' in num:
        return False
    ...
    while i < len(digito):
        if i > 0:
            if digito[i] == digito[i-1]:
                return False
        if digito[0] == digito[len(digito)-1]:
            return False
        soma += int(digito[i])
        i += 1
    if (soma % 2) != 0:
...
def troca_caixa(texto):
    ...
    novo_texto = ''
    while letra < len(texto):
        if texto[letra] in vogal:
            novo_texto += texto[letra].upper()
        else:
            novo_texto += texto[letra].lower()
        letra += 1
    return novo_texto
...
def imprime_mes_por_extenso(data):
    ...
    while i <= len(meses):
        if mes == i:
            data_extenso = dia + ' de ' + meses[i] + ' de ' + ano 
        i += 1
    return data_extenso
...
def numeros_sortudos(limite_inferior=1, limite_superior=100000):
    ...
    while limite_inferior <= limite_superior:
        if identifica_sortudo(limite_inferior):
            qtd_sortudos += 1
        limite_inferior +=1
    return qtd_sortudos
...
def ponteironuloville(telefones):
    ...
    '''
    i = 0
    qtd_numeros_validos = 0
    while i < len(telefones):
        if verifica_digitos(telefones[i]) == True:
            
            qtd_numeros_validos += 1
        i +=1
    return qtd_numeros_validos
...
def main():
    ...
    telefones = '''213752 216732 221063 221545 225583 229133 230648 233222 236043 237330 239636 240138 242123 246224 249183 252936 254711 257200 257607 261424 263814 266794 268649 273050 275001 277606 278997 283331 287104 287953 289137 291591 292559 292946 295180 295566 297529 300400 304707 306931 310638 313595 318449 319021 322082 323796 326266 326880 327249 329914 334392 334575 336723 336734 338808 343269 346040 350113 353631 357154 361633 361891 364889 365746 365749 366426 369156 369444 369689 372896 374983 375223 379163 380712 385640 386777 388599 389450 390178 392943 394742 395921 398644 398832 401149 402219 405364 408088 412901 417683 440052 444630 463328 466458 486195 488359 500877 502386 521455 524277 536593 537360 556493 558807 579937 580112 590483 593112 601523 605761 618314 622752 637656 641136 662224 666265 422267 447852 469601 489209 502715 528496 539055 559102 580680 593894 608618 626345 644176 668010 424767 449116 473108 489388 507617 529345 540582 562050 582458 594293 609198 626632 644973 672480 426613 453865 476773 491928 512526 531231 543708 564962 583012 597525 610141 628889 647617 672695 430474 457631 477956 496569 512827 531766 547492 569677 585395 598184 610536 629457 652218 676868 433910 461750 481991 496964 513796 535067 550779 570945 586244 600455 612636 629643 657143 677125 435054 462985 482422 497901 518232 535183 551595 575447 587393 600953 615233 633673 659902 678315'''.split()
